    ...
    <div className="min-h-screen flex flex-col items-center p-4 sm:p-6 lg:p-8">
      ...
      <div className="w-full max-w-4xl mb-6 text-center space-y-2">
        ...
        <p className="text-sm text-gray-400">
          Privacy Policy and Terms of Service for Our Application.
        </p>
      </div>

      {/* Glassmorphism container */}
      <div className="relative w-full max-w-4xl rounded-2xl border border-white/10 bg-white/5 shadow-[0_0_1px_0_rgba(255,255,255,0.25),0_20px_60px_-20px_rgba(0,0,0,0.6)] backdrop-blur-md supports-[backdrop-filter]:bg-white/5 p-6 sm:p-8 space-y-10 text-white">
        {/* Table of contents */}
        <nav>
          <h2 className="font-semibold mb-2 text-white">Contents</h2>
          <ul className="list-disc pl-6 space-y-1 text-gray-300">
            ...
            <li>
              <a className="text-blue-400 hover:underline" href="#terms-of-service">
                Terms of Service
              </a>
            </li>
          </ul>
        ...
        <section id="privacy-policy" className="space-y-4 scroll-mt-24">
          ...
          <p>
            ...
            disclose, and safeguard your information when you use our website or services.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-300">
            <li>With platform APIs (e.g., X, LinkedIn, Instagram) solely to perform requested actions.</li>
          ...
          <p>
            Authentication and posting features rely on third‑party platforms (e.g., X, Google, GitHub), which
            have their own policies and terms.
          </p>
          ...
          <p>
            Email:{' '}
            <a className="text-blue-400 hover:underline" href="mailto:hello@jinoshare.com">
              hello@jinoshare.com
            </a>
          </p>
        </section>
        ...
        {/* Terms of Service */}
        <section id="terms-of-service" className="space-y-4 scroll-mt-24">
          <h2 className="text-2xl font-bold">Terms of Service</h2>
          <p className="text-sm text-gray-400">Effective Date: {effectiveDate}</p>

          <p>
            Welcome to our application. By accessing or using our platform, you agree to these Terms of
            Service (“Terms”).
          </p>
          ...
          <p>
            You may log in using supported providers (e.g., Google, GitHub, Facebook, X). You are responsible
            for managing your linked accounts and any content posted.
          </p>
          ...
          <p>
            The service is provided “as is.” We make no guarantees about uptime, performance, or outcomes and
